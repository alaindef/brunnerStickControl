...
class UdpSender() {
    ...
    fun sendUDP(forceX: Float, forceY: Float) {
        ...
        val byteMessage =
            convertTheIndians(intArrayOf(0xAE, forceY.toInt(), 0, forceX.toInt(), 0, 0, 0, 0, 0))
        try {
